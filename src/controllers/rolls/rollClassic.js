...
exports.roll1d4 = ctx => {
  ...
  switch (result) {
    case 1:
      return ctx.reply(
        `Кровь кровавому богу! Черепа, ко трону черепов!(${result})`
      );
    ...
    default:
      return ctx.reply(
        `Твой бог под номером: ${result}. Хотя какая тебе разница?`
      );
  }
};
...
exports.roll1d10 = ctx => {
  ...
  return ctx.reply(`Я бы скзал: ${result}`);
};
...
exports.roll1d20 = ctx => {
  ...
  switch (result) {
    ...
    case 2:
      return ctx.reply(
        `Неизвестен - все записи стёрты до Ереси Хоруса (${result})`
      );
    case 3:
      return ctx.reply(
        `Совершенство или смерть! - Дети Императора (${result})`
      );
    case 4:
      return ctx.reply(
        `Железо внутри, железо снаружи! - Железные войны (${result})`
      );
    case 5:
    ...
    case 7:
      return ctx.reply(
        `Примарх-прародитель! Во славу Твою и во славу Его на земле! - Имперские Кулаки(${result})`
      );
    case 8:
    ...
    case 12:
      return ctx.reply(
        `Кровь для Бога Крови! Черепа для Трона Черепов! - Пожиратели Миров (${result})`
      );
    case 13:
    ...
    case 16:
      return ctx.reply(
        `Мы вернулись! Смерть Ложному Императору! - Чёрный Легион (${result})`
      );
    case 17:
      return ctx.reply(
    ...
    case 18:
      return ctx.reply(
        `В пламя битвы, на наковальню войны! - Саламандры (${result})`
      );
    case 19:
      return ctx.reply(
        `Victorus aut Mortis ("Победа или смерть"). - Гвардия Ворона(${result})`
      );
    case 20:
      return ctx.reply(`Гидра Доминатус! - Альфа-Легион (${result})`);
    default:
      return ctx.reply(
        `Твой легион: Жопа Гуся (${result}), но я про такой не слышал`
      );
  }
};
